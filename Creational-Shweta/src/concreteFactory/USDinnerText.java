...
public class USDinnerText implements CreateMenuGenerator,CreateMenuFormatter,CreateReader{
	...
	public USDinnerText() throws Exception
	{
		@SuppressWarnings("unchecked")
		ArrayList<Xml> data=reader.getReader("US");
		ArrayList<Xml> newData=menugenerator.getMenu(data,"Diner");
		for(int i=0;i<newData.size();i++)
		{
		//	System.out.println(newData.get(i).toString());
		}
		menuformatter.generateMenu(newData,"Text","USD");
	}
