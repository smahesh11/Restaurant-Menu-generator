...
public class GBAllDayXML implements CreateMenuGenerator,CreateMenuFormatter,CreateReader{
	...
	public GBAllDayXML() throws Exception
	{
		...
		menuformatter.generateMenu(newData,"XML","GBP");
	}
