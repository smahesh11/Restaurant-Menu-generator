...
public class GBAllDayHTML  implements CreateMenuGenerator,CreateMenuFormatter,CreateReader{
	...
	public GBAllDayHTML() throws Exception
	{
		...
		menuformatter.generateMenu(newData,"HTML","GBP");
	}
}
